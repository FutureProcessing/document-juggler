...
public class AddToSetManyUpdateCommandTest {

    private static final String FIELD = "testField";
    private static final String VALUE_1 = "SomeValue";
    private static final String VALUE_2 = "AnotherValue";

    private UpdateCommand command = new AddToSetManyUpdateCommand(FIELD);
    ...
    public void shouldAddToSet() {
        ...
        // when
        command.update(builder, new Object[]{VALUE_1, VALUE_2});
